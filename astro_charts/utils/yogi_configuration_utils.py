...
def calculate_yogi_configurations(natal_data: Dict[str, Any], transit_data: Dict[str, Any], orb: float = 3.0) -> Dict[str, Any]:
    ...
    try:
        ...
        from .yogi_point_utils import calculate_yogi_point
        yogi_point = calculate_yogi_point(transit_data)
        ...
        if "houses" in transit_data["transit"]["subject"] and "ascendant" in transit_data["transit"]["subject"]["houses"]:
            ...
            ascendant_lord = get_ascendant_ruler(ascendant_sign, zodiac_type="Sidereal")
        ...
        triple_alignments = calculate_triple_alignments(
        ...
        yearly_power_alignments = find_yearly_power_alignments(
            yogi_point=yogi_point,
